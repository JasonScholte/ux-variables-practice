...
let mySnack = (death - age) * (bagPerDay * eachYear);
console.log(mySnack)
// 5. Create a variable called message describing your result.
// "You will need NN to last you until the ripe old age of X".
let firstPart = "I will need ";
let secondPart = " to last me until the rip old age of ";
let periodPart = ".";
let theAnswer = (firstPart + mySnack + secondPart + death + periodPart);
...
let possibleBirthday = (future - birth);
let nextAgeUp = (future - birth + 1)
console.log(possibleBirthday);
console.log(nextAgeUp);

// 4. Create a variable called message which describes the result.
// "I will be either NN or NN in YYYY", substituting the values.
let either = "I will be either ";
let theOrPart = " or ";
let theInPart = " in ";
let theAges = (either + possibleBirthday + theOrPart + nextAgeUp  + theInPart + future + periodPart);
...
let multiplyNum = 9;
let thirtyTwo = 32;
let fahrStepOne = (celciusTemp / 5) * multiplyNum;
let fStepTwo = fahrStepOne + 32;
...
let degreeF = "°F"
let degreeC = "°C"
let tempChange = (celciusTemp + degreeC + theIs + fStepTwo + degreeF + periodPart)
console.log(tempChange);

// 4. Now store a fahrenheit temperature into a variable.
let fahrenheitTemp = 116;

// 5. Convert it to celsius  and store that in a new variable.
let celStepOne = (fahrenheitTemp - 32) * 5;
let celStepTwo = celStepOne / 9;



// 6. Output to console.log() in the format "NN°F is NN°C."
let tempBack = (fahrenheitTemp + degreeF + theIs + celStepTwo + degreeC + periodPart)
